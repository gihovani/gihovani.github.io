...
export const pegaTextoDoElemento = (elemento: Element | null, atributo: string): string => {
...
export const formataNumeroEmDinheiro = (numero: number | null): string => {
    return numero ? numero.toLocaleString('pt-br', {minimumFractionDigits: 2, maximumFractionDigits: 2}) : '0,00';
};
